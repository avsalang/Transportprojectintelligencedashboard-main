    ...
    <div className="px-6 py-4 border-b border-slate-200 bg-white/95 backdrop-blur-md sticky top-0 z-30 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-4">
          <div>
              <h2 className="text-slate-900 text-lg tracking-tight">Filters</h2>
              {activeCount > 0 && (
            ...
            <p className="text-slate-500 text-[14px] mt-0.5 font-normal">
              Analyzing <span className="text-slate-900 font-medium">{filteredFacts.length.toLocaleString()}</span> ATO-relevant CRS transaction lines
            </p>
          </div>
