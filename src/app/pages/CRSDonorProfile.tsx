...
export function CRSDonorProfile() {
  ...
  const donorProjectRecordRows = useMemo<ProjectRecordTableRecord[]>(
  ...
  return (
    <div className="p-6 bg-[#F8FAFC] min-h-screen">
      <div className="max-w-[1440px] mx-auto space-y-6">
        ...
        <ProjectRecordsTable
          records={donorProjectRecordRows}
          columns={['year', 'record', 'agency', 'recipient', 'mode', 'flow', 'themes', 'amount']}
          subtitle="Records for the selected donor. Donor is fixed by the profile selection."
          emptyMessage="No project records match the current donor filters and search."
