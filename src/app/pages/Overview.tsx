    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="text-right">
          <p className="text-slate-400 text-[11px] uppercase tracking-wide">Current mode taxonomy</p>
          <p className="text-slate-700 text-sm">Refined presentation categories</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-[2fr,1fr] gap-4">
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <div>
              <p className="text-slate-900 text-sm font-semibold">Global Project Map</p>
              <p className="text-slate-400 text-xs mt-0.5">{mapSubtitle}</p>
            </div>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
            <p className="text-slate-800 text-sm font-semibold mb-3">Financing by MDB</p>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          <p className="text-slate-800 text-sm font-semibold mb-1">Approvals Over Time</p>
          <p className="text-slate-400 text-xs mb-4">Project approvals in the current portfolio view</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-5">
          ...
          <p className="text-slate-400 text-xs mb-4">Current portfolio view by project count</p>
          <ResponsiveContainer width="100%" height={230}>
            <BarChart data={countryData} layout="vertical" margin={{ top: 0, right: 8, left: 0, bottom: 0 }}>
              ...
              <Tooltip contentStyle={{ fontSize: 12, borderRadius: 8, border: '1px solid #E2E8F0' }} formatter={(v: number) => [v.toLocaleString(), 'Projects']} />
