...
def main():
    ...
    OUT_RECORDS_JSON.parent.mkdir(parents=True, exist_ok=True)
    OUT_RECORDS_JSON.write_text(
        json.dumps(payload["records"], ensure_ascii=False, separators=(",", ":")),
        encoding="utf-8",
    )
    ...
    print(f"Wrote {OUT_RECORDS_JSON}")
